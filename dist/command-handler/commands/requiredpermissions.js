...
const RequiredPermissionsEntity_1 = require("../../models/RequiredPermissionsEntity");
...
exports.default = {
    ...
    autocomplete: (command, arg) => {
        ...
        if (arg === "permission")
            return [
                clearAllPermissions,
                ...Object.keys(discord_js_1.PermissionFlagsBits),
            ];
    },
    callback: async (commandUsage) => {
        ...
        const repo = await DCMD_1.ds.getRepository(RequiredPermissionsEntity_1.RequiredPermissionsEntity);
        if (!permission) {
